...
import com.example.profilesettingsapp.databinding.FragmentViewPagerItemBinding
import java.util.*
...
class ViewPagerItemFragment : Fragment() {
    ...
    private fun filterList(query: String?) {
        ...
        if (query != null) {
            ...
            for (i in list) {
                if (i.app_name.lowercase(Locale.ROOT).contains(query) || i.app_name.uppercase(Locale.ROOT).contains(query)) {
                    filteredList.add(i)
                }
            }
